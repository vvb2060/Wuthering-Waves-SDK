...
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_GA_Common_QTEnew_C;                 // 0x0568(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
	...
	class UBP_QTE_Camera_C*                       RogueQteCamera_2;                                  // 0x06A0(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          已切回角色;                                        // 0x06A8(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)
	uint8                                         Pad_6A9[0x3];                                      // 0x06A9(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FGameplayTag                           今汐Tag;                                           // 0x06AC(0x000C)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
	struct FGameplayTag                           赞尼Tag;                                           // 0x06B8(0x000C)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
	int32                                         层数;                                              // 0x06C4(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(UGA_Common_QTEnew_C) == 0x0006C8, "Wrong size on UGA_Common_QTEnew_C");
static_assert(offsetof(UGA_Common_QTEnew_C, UberGraphFrame_GA_Common_QTEnew_C) == 0x000568, "Member 'UGA_Common_QTEnew_C::UberGraphFrame_GA_Common_QTEnew_C' has a wrong offset!");
static_assert(offsetof(UGA_Common_QTEnew_C, 相机配置) == 0x000570, "Member 'UGA_Common_QTEnew_C::相机配置' has a wrong offset!");
static_assert(offsetof(UGA_Common_QTEnew_C, 原来的角色) == 0x000688, "Member 'UGA_Common_QTEnew_C::原来的角色' has a wrong offset!");
static_assert(offsetof(UGA_Common_QTEnew_C, RogueQteCamera) == 0x000690, "Member 'UGA_Common_QTEnew_C::RogueQteCamera' has a wrong offset!");
static_assert(offsetof(UGA_Common_QTEnew_C, QTE时停子弹) == 0x000698, "Member 'UGA_Common_QTEnew_C::QTE时停子弹' has a wrong offset!");
static_assert(offsetof(UGA_Common_QTEnew_C, QTE时停子弹2) == 0x00069C, "Member 'UGA_Common_QTEnew_C::QTE时停子弹2' has a wrong offset!");
static_assert(offsetof(UGA_Common_QTEnew_C, RogueQteCamera_2) == 0x0006A0, "Member 'UGA_Common_QTEnew_C::RogueQteCamera_2' has a wrong offset!");
static_assert(offsetof(UGA_Common_QTEnew_C, 已切回角色) == 0x0006A8, "Member 'UGA_Common_QTEnew_C::已切回角色' has a wrong offset!");
static_assert(offsetof(UGA_Common_QTEnew_C, 今汐Tag) == 0x0006AC, "Member 'UGA_Common_QTEnew_C::今汐Tag' has a wrong offset!");
static_assert(offsetof(UGA_Common_QTEnew_C, 赞尼Tag) == 0x0006B8, "Member 'UGA_Common_QTEnew_C::赞尼Tag' has a wrong offset!");
static_assert(offsetof(UGA_Common_QTEnew_C, 层数) == 0x0006C4, "Member 'UGA_Common_QTEnew_C::层数' has a wrong offset!");
