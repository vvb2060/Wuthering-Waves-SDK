...
public:
	...
	class UCapsuleComponent*                      Bip001RForearm_Bone;                               // 0x0770(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
	class UCapsuleComponent*                      Bip001LForearm_Bone;                               // 0x0778(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
	class UCapsuleComponent*                      Bip001Spine1_Bone;                                 // 0x0780(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
	class UCapsuleComponent*                      Bip001Head_Bone;                                   // 0x0788(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(ABP_ME1QunJingMd00001_C) == 0x000790, "Wrong size on ABP_ME1QunJingMd00001_C");
...
static_assert(offsetof(ABP_ME1QunJingMd00001_C, Bip001RForearm_Bone) == 0x000770, "Member 'ABP_ME1QunJingMd00001_C::Bip001RForearm_Bone' has a wrong offset!");
static_assert(offsetof(ABP_ME1QunJingMd00001_C, Bip001LForearm_Bone) == 0x000778, "Member 'ABP_ME1QunJingMd00001_C::Bip001LForearm_Bone' has a wrong offset!");
static_assert(offsetof(ABP_ME1QunJingMd00001_C, Bip001Spine1_Bone) == 0x000780, "Member 'ABP_ME1QunJingMd00001_C::Bip001Spine1_Bone' has a wrong offset!");
static_assert(offsetof(ABP_ME1QunJingMd00001_C, Bip001Head_Bone) == 0x000788, "Member 'ABP_ME1QunJingMd00001_C::Bip001Head_Bone' has a wrong offset!");
