...
static_assert(sizeof(UGA_Destroy_Zhaohuan_Vision_C) == 0x0005F8, "Wrong size on UGA_Destroy_Zhaohuan_Vision_C");
static_assert(offsetof(UGA_Destroy_Zhaohuan_Vision_C, UberGraphFrame_GA_Destroy_Zhaohuan_Vision_C) == 0x000568, "Member 'UGA_Destroy_Zhaohuan_Vision_C::UberGraphFrame_GA_Destroy_Zhaohuan_Vision_C' has a wrong offset!");
static_assert(offsetof(UGA_Destroy_Zhaohuan_Vision_C, 召唤者ID) == 0x000570, "Member 'UGA_Destroy_Zhaohuan_Vision_C::召唤者ID' has a wrong offset!");
static_assert(offsetof(UGA_Destroy_Zhaohuan_Vision_C, 召唤者) == 0x000578, "Member 'UGA_Destroy_Zhaohuan_Vision_C::召唤者' has a wrong offset!");
static_assert(offsetof(UGA_Destroy_Zhaohuan_Vision_C, 材质Handle) == 0x000580, "Member 'UGA_Destroy_Zhaohuan_Vision_C::材质Handle' has a wrong offset!");
static_assert(offsetof(UGA_Destroy_Zhaohuan_Vision_C, 材质配置) == 0x000588, "Member 'UGA_Destroy_Zhaohuan_Vision_C::材质配置' has a wrong offset!");
static_assert(offsetof(UGA_Destroy_Zhaohuan_Vision_C, 外部结束) == 0x000590, "Member 'UGA_Destroy_Zhaohuan_Vision_C::外部结束' has a wrong offset!");
static_assert(offsetof(UGA_Destroy_Zhaohuan_Vision_C, 伴生物销毁材质Handle) == 0x000598, "Member 'UGA_Destroy_Zhaohuan_Vision_C::伴生物销毁材质Handle' has a wrong offset!");
static_assert(offsetof(UGA_Destroy_Zhaohuan_Vision_C, 伴生物数量) == 0x0005E8, "Member 'UGA_Destroy_Zhaohuan_Vision_C::伴生物数量' has a wrong offset!");
static_assert(offsetof(UGA_Destroy_Zhaohuan_Vision_C, 召唤销毁材质) == 0x0005F0, "Member 'UGA_Destroy_Zhaohuan_Vision_C::召唤销毁材质' has a wrong offset!");
