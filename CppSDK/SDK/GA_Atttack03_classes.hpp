...
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_GA_Atttack03_C;                     // 0x0568(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
...
static_assert(sizeof(UGA_Atttack03_C) == 0x000570, "Wrong size on UGA_Atttack03_C");
static_assert(offsetof(UGA_Atttack03_C, UberGraphFrame_GA_Atttack03_C) == 0x000568, "Member 'UGA_Atttack03_C::UberGraphFrame_GA_Atttack03_C' has a wrong offset!");
