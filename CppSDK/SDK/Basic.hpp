...
namespace Offsets
{
	constexpr int32 GObjects          = 0x08608D28;
	constexpr int32 AppendString      = 0x02A01E90;
	constexpr int32 GNames            = 0x085AC2C0;
	constexpr int32 GWorld            = 0x084C55C0;
	constexpr int32 ProcessEvent      = 0x02C0B1A0;
